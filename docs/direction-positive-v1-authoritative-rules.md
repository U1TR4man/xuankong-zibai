...
### 0.5.5 尚未親自核對的部分（2026-08-10 已大幅縮小）

初版時《欽定協紀辨方書》相關條目尚未讀取。**後續已補讀四庫本卷十四、卷二十至三十一、卷三十四**，
〈月吉神總論〉〈火星〉〈制煞要法〉〈諸家年月日吉凶神附論〉全部核到原文，
逐條結果見 `docs/primary-source-verification-2026-08.md`。

**仍未核到**：《造命宗鏡集》全部條目、《新刊類編陰陽選擇合併通書大全》卷十二〈三德格〉與「三德叢聚」一詞、
《三命通會》引《大統曆》四維互合異說、歲德與歲德合「並屬上吉」。

因此三德叢聚目前**只有本專案的 120 組全枚舉推導**，四組結果由三張已核對的表導出故不受影響，
但「三德叢聚」這個**名詞**與其古籍地位仍待核。
...
| 歲德 / 歲德合 | **同級，皆 `primary_virtue`** | 消極推論：〈月吉神總論〉未給等級（見下） |

初版把六者一律按「本德／合德」二分，對**歲家**沒有依據。

**2026-08-10 修正**：已核到《協紀》四庫本卷三十四〈月吉神總論〉原文——

> 天徳方即天道方，月徳方即三合月官旺之間，大吉。**天徳合、月徳合方次吉。**此四德到方大能制此方之煞。**併歳徳、歳徳合共名六徳**，俱走天干不走地支，不能制地支方煞也。

原文只給**天、月兩家**等級（本德大吉、合德次吉），**完全沒有**給歲德、歲德合任何等級，只把它們併入六德。

因此：

- 天德／月德 `primary_virtue`、天德合／月德合 `combined_virtue` —— **有原文依據**。
- 歲德／歲德合同為 `primary_virtue` —— **只是「未被列為次吉」的消極推論**，不是積極證據。獨立覆核稿所引「並屬上吉」一句本輪未核到，維持 `primarySourceVerified = false`（就 `role` 而言；兩張表本身已核對）。

編者另有「歲德偏剛、歲德合偏柔」之說，同時自陳「選擇家未論及此」，屬編者意通，**不得轉成 ranking 權重**。
...
**2026-08-10 已核對**：《協紀》四庫本**卷三十三**〈論修方〉直接載有——

> 二曰修吉神方，或太歲方而**帶吉不帶凶**也，或**三德方，如甲年六月，則歲徳、天徳、月徳㑹扵甲方也**。

因此「**三德方**」是古籍既有名詞，「甲年六月→甲方」亦為原文，兩者皆已核到固定版本。
先前把此例歸給《造命宗鏡集》卷五，實際在《協紀》卷三十三可讀到（卷三十三、三十四多引選擇宗鏡）。

**但「三德叢聚」一詞仍未核到**：維基文庫全站無選擇學脈絡的用例，《協紀》全書只有卷三十三出現「三德」，
用的是「三德方」。獨立覆核稿把「叢聚」歸給《通書大全》卷十二〈三德格〉，該書不在維基文庫，無法核對。

**UI 一律使用已核對的「三德方」**，不得顯示「三德叢聚」。
...
- 「三德方」是**古籍既有名詞**，不是現代自創 heuristic，UI 使用此詞。
- §3.3 的四組中，甲己年未月一組已有《協紀》卷三十三原文對照；其餘三組仍為本專案推導。
- **識別碼**：程式仍作 `sanDeCongJu`。此名建立在未核到的「叢聚」上，是否改為 `sanDeFang`
  屬第二次更名且不影響行為，留待使用者決定（見 `docs/primary-source-verification-2026-08.md` §8.2）。
...
export interface DirectionVirtueEvidence {
  ...
  // 歲德與歲德合同為 primary_virtue（原文未給等級，屬消極推論），見 §1
...
- [x] 天德／月德為 primary、兩合德為 secondary（〈月吉神總論〉原文）
- [ ] 歲德與歲德合的等級：原文未給，同級屬消極推論，待補證
