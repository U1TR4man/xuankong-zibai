...
- 0–4 顆紫白分別顯示「無紫白集中／紫白到方／二時紫白同加／三時紫白集中／四時紫白同到」。三時是 2 與 4 之間的工具分級，不冒稱古訣專名。
- 主盤可見 `n/4` 與集中訊號；方向詳情顯示實際命中層。
...
- 320px 方向詳情正確顯示 3/4、命中層、氣／墓絕 unknown、白中殺 unknown。
- 320px 的 68 學習卡顯示直接有序、宮星＋流年、原頁未核、`rankingWeight=0` 及 `reference_only`；37 卡顯示疑似 36 的轉錄異文。
