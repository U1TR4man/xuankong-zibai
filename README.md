...
- 自帶約 221 KB `Zibai Serif`（Noto Serif CJK TC Medium 2.003、860 個 UI 字元子集，SIL OFL 1.1），PWA 預載／離線快取，單檔版改為 data URI 內嵌；可用 `scripts/build-font-subset.py` 從專案靜態 UI 文字重建。
