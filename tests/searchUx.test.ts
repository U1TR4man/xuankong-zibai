...
describe('Phase 5 搜尋結果 UX', () => {
  ...
  it('長範圍與大量結果均明確提示，且不偷偷截斷', () => {
    ...
    expect(view.querySelectorAll('.search-result')).toHaveLength(50);
    ...
    expect(more.textContent).toContain('再顯示 50');
    expect(more.textContent).toContain('尚餘 151');
    more.click();
    expect(view.querySelectorAll('.search-result')).toHaveLength(100);
    more.click();
    more.click();
    more.click();
